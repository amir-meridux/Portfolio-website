      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-primary mb-6 tracking-tight">
            Selected <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-400">
              Projects.
            </span>
          </h2>
                  ...
                  {project.diagram.map((step, stepIdx) => (
                    <React.Fragment key={stepIdx}>
                      <motion.div 
                        ...
                        className="px-6 py-4 bg-blue-50/50 backdrop-blur-sm border border-blue-100/50 shadow-sm rounded-xl font-semibold text-primary w-full max-w-[240px] text-center transition-all duration-300 cursor-default"
                      >
                        {step}
                      </motion.div>
